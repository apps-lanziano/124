...
- פתחתי **100 מסכים** ובדקתי שכולם נטענים ומציגים נתונים
...
1 מופעים (שורה 3081). מפתח Web של Firebase הוא ציבורי מעצם טיבו — ההגנה בפועל היא כללי מסד הנתונים + App Check. לא נדרשת פעולה, בתנאי ששני אלה מופעלים.
...
**🔵 מידע · גודל האפליקציה**
887 KB, 12,274 שורות בקובץ יחיד. סביר לקובץ יחיד. מעקב בלבד.
