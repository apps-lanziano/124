...
1 מופעים (שורה 3038). מפתח Web של Firebase הוא ציבורי מעצם טיבו — ההגנה בפועל היא כללי מסד הנתונים + App Check. לא נדרשת פעולה, בתנאי ששני אלה מופעלים.
...
**🔵 מידע · גודל האפליקציה**
875 KB, 12,097 שורות בקובץ יחיד. סביר לקובץ יחיד. מעקב בלבד.
