...
1 פונקציות מעל 120 שורות. הארוכות: applyLoginUiForRole (123 שורות, שורה 4414). פיצול יקל על תחזוקה ויקטין סיכון לבאגים.
...
**🔵 מידע · גודל האפליקציה**
843 KB, 13,904 שורות בקובץ יחיד. סביר לקובץ יחיד. מעקב בלבד.
