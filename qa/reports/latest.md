...
- הרצתי **134 בדיקות** שמוודאות שתקלות שכבר תוקנו לא חזרו
...
134 קבצי בדיקה, כולם ירוקים — כל מנגנוני הכתיבה הקריטיים תקינים.
...
1 מופעים (שורה 4042). מפתח Web של Firebase הוא ציבורי מעצם טיבו — ההגנה בפועל היא כללי מסד הנתונים + App Check. לא נדרשת פעולה, בתנאי ששני אלה מופעלים.
...
1228 KB, 17,679 שורות בקובץ יחיד. מעל 900KB — כל טעינה ראשונה מורידה את הכל. שווה לשקול פיצול ה-CSS/JS לקבצים נפרדים שנשמרים במטמון בנפרד.

**🟡 קל · פונקציות שלא נקראות מאף מקום**
2 פונקציות: renderBoardArchive, hebDayOffset. מועמדות למחיקה — פחות קוד, פחות מקום לטעות.

**🟡 קל · שדות קלט ללא תיאור**
1 שדות בלי aria-label/placeholder/id.

**🟡 קל · פונקציות ארוכות מאוד**
4 פונקציות מעל 120 שורות. הארוכות: renderRosterEditor (148 שורות, שורה 9287), applyLoginUiForRole (145 שורות, שורה 4973), renderRosterView (130 שורות, שורה 7448). פיצול יקל על תחזוקה ויקטין סיכון לבאגים.
...
1. **גודל האפליקציה** — 1228 KB, 17,679 שורות בקובץ יחיד.
