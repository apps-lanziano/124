...
1 מופעים (שורה 3034). מפתח Web של Firebase הוא ציבורי מעצם טיבו — ההגנה בפועל היא כללי מסד הנתונים + App Check. לא נדרשת פעולה, בתנאי ששני אלה מופעלים.
...
**🔵 מידע · גודל האפליקציה**
872 KB, 12,045 שורות בקובץ יחיד. סביר לקובץ יחיד. מעקב בלבד.
