...
1 מופעים (שורה 3485). מפתח Web של Firebase הוא ציבורי מעצם טיבו — ההגנה בפועל היא כללי מסד הנתונים + App Check. לא נדרשת פעולה, בתנאי ששני אלה מופעלים.
...
1 פונקציות מעל 120 שורות. הארוכות: applyLoginUiForRole (123 שורות, שורה 4386). פיצול יקל על תחזוקה ויקטין סיכון לבאגים.
...
**🔵 מידע · גודל האפליקציה**
841 KB, 13,876 שורות בקובץ יחיד. סביר לקובץ יחיד. מעקב בלבד.
