...
1 מופעים (שורה 2882). מפתח Web של Firebase הוא ציבורי מעצם טיבו — ההגנה בפועל היא כללי מסד הנתונים + App Check. לא נדרשת פעולה, בתנאי ששני אלה מופעלים.
...
**🔵 מידע · גודל האפליקציה**
831 KB, 11,362 שורות בקובץ יחיד. סביר לקובץ יחיד. מעקב בלבד.
