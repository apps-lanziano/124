...
function buildAnalysisPrompt() {
  return [
    ...
    "- כלל הצבע: שם שצבוע/מסומן ברקע ירוק משמעו שהאדם ב\"תורן נח\" (rest).",
    '  שם בצבע/רקע רגיל (לא ירוק) הוא בצוות התורן הפעיל (duty).',
    "- שמות בלוח עשויים להיות כתובים בשם פרטי בלבד, בשם משפחה בלבד, או שם מלא —",
    "  כתוב בדיוק את הטקסט כפי שהוא מופיע בלוח, בלי לתקן איות ובלי להשלים",
    "  בעצמך לשם מלא (השלמת השם המלא מול רשימות הצוות תתבצע בשלב נפרד).",
