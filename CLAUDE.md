...
**השבתה ידנית של שורה (`rosterDisabledRows`):** בעורך הלוח, הקשה על כותרת שורה קבוצתית (מתגבר/PF/נחים PF/PMS/PMS נחים/מילואים/תורנות, וגם שורות מותאמות-אישית) מסמנת אותה "מושבתת" — נשמר גלובלית תחת `roster_disabled_rows` (`toggleRosterRowDisabled`). שורה מושבתת לא מוצגת בלוח **בשום מצב**, גם אם יש בה שיבוץ בפועל — שונה מ"לא מאוישת" שמתעדכן אוטומטית לפי הנתונים. משפיע גם על לוח נוכחי וגם עתידי (אותה הגדרה גלובלית, לא לכל שבוע).
